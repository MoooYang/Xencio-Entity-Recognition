    ...
    def __init__(self, args):
        ...
        if args.mode == 'BERT':
            ...
            with Pool(processes=1) as pool:
                ...
                # 修改，如果不存在label的pickle文件，则从cfg里读
                num_labels, label2id, id2label = init_predict_var(self.args.model_dir, self.args.label_list)
...
def init_predict_var(path, default_label_list):
    """
    初始化NER所需要的一些辅助数据
    :param path:
    :return:
