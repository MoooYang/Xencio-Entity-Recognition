...
class NerProcessor(DataProcessor):
    ...
    def get_labels(self, labels=None):
        ...
        # 修改，在结束后永远往output里输出label_list.pkl
        #with codecs.open(os.path.join(self.output_dir, 'label_list.pkl'), 'wb') as rf:
            #pickle.dump(self.labels, rf)
...
def train(args, customer_label_list = []):
    ...
    if customer_label_list == []:
        ...
        label_list = customer_label_list

    # 修改，一定会将label_list.pkl输出
    with codecs.open(os.path.join(args.output_dir, 'label_list.pkl'), 'wb') as rf:
